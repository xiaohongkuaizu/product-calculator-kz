    ...
    loadSettings() {
        ...
        if (savedOptions) {
            try {
                ...
                // 默认首付比例选项
            this.downPaymentOptions = [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.6];
            }
        } else {
            // 默认首付比例选项
            this.downPaymentOptions = [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.6];
        ...
        if (savedRates) {
            try {
                ...
                // 默认费率配置（首付比例 × 租期）
                this.interestRates = {
                    6: { 0.1: 0.17, 0.15: 0.17, 0.2: 0.17, 0.25: 0.17, 0.3: 0.17, 0.35: 0.17, 0.4: 0.17, 0.45: 0.17, 0.5: 0.17, 0.6: 0.17 },
                    12: { 0.1: 0.20, 0.15: 0.20, 0.2: 0.20, 0.25: 0.20, 0.3: 0.20, 0.35: 0.20, 0.4: 0.20, 0.45: 0.20, 0.5: 0.20, 0.6: 0.20 },
                    18: { 0.1: 0.23, 0.15: 0.23, 0.2: 0.23, 0.25: 0.23, 0.3: 0.23, 0.35: 0.23, 0.4: 0.23, 0.45: 0.23, 0.5: 0.23, 0.6: 0.23 },
                    24: { 0.1: 0.26, 0.15: 0.26, 0.2: 0.26, 0.25: 0.26, 0.3: 0.26, 0.35: 0.26, 0.4: 0.26, 0.45: 0.26, 0.5: 0.26, 0.6: 0.26 }
                };
            }
        } else {
            // 默认费率配置（首付比例 × 租期）
