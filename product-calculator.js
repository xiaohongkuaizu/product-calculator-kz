    ...
    loadSettings() {
        ...
        if (savedRates) {
            try {
                ...
                // 默认费率配置（首付比例 × 租期）
                this.interestRates = {
                    6: { 0.1: 0.17, 0.15: 0.17, 0.2: 0.17, 0.25: 0.255, 0.3: 0.235, 0.35: 0.23, 0.4: 0.22, 0.45: 0.17, 0.5: 0.17, 0.6: 0.17 },
                    9: { 0.1: 0.17, 0.15: 0.17, 0.2: 0.17, 0.25: 0.275, 0.3: 0.268, 0.35: 0.268, 0.4: 0.265, 0.45: 0.17, 0.5: 0.17, 0.6: 0.17 },
                    12: { 0.1: 0.20, 0.15: 0.20, 0.2: 0.20, 0.25: 0.298, 0.3: 0.298, 0.35: 0.295, 0.4: 0.285, 0.45: 0.20, 0.5: 0.20, 0.6: 0.20 }
                };
            }
        } else {
            // 默认费率配置（首付比例 × 租期）
